...
var layers = {
  ...
  SANDERS: new L.LayerGroup(),
  BIDEN: new L.LayerGroup(),
...
// -------------------------------------------------------------------------------------------------
//              I C O N S:               Initialize an object containing icons for each layer group
// -------------------------------------------------------------------------------------------------
...
urlFlask = "http://127.0.0.1:5000/api/v1/presidents"
...
//d3.json("data_candidates_file.json", function(dataRows) {
  ...
  for (i = 0; i < dataRows.length; i++) {
    ...
    console.log("President:", president)
      ...
      // Note: This newMArker applies to only Presidential Candidates
      //                                                Alemi March 5 2020
      // -----------------------------------------------------------------------------
      ...
      //console.log("candLat:",candLat)
      //console.log("candLong:",candLong)
      //console.log("candAnswer:",candAnswer)


      var newMarkerP = L.marker([candLat, candLong], {
      ...
      newMarkerP.bindPopup(president.answer + "<br> votes percentage: " + president.pct + "<br>" + president.state + " State");
...
d3.json(queryUrl, function(data) {
  // Once we get a response, send the data.features object to the createEarthqFeatures function
...
d3.json(queryUrl2, function(data2) {
  // Once we get a response, send the data2.features object to the createPolyFeatures function

  createPolyFeatures(data2.features);
});
var earthCount = {
  COMING_SOON: 0,
  EMPTY: 0,
...
//                                                            Alemi March 6, 2020
//  ================================================================================
function createEarthqFeatures(eqData) {
  ...
  //console.log("createEarthqFeatures of earthquake");
  ...
  function onEachEarthq(feature, layer) {
  ...
  //    Run the onEachEarthq function once for each piece of data in the array
  //    onEachFeature is Leaflet component.                 Piruz March 5th, 2020
  // --------------------------------------------------------------------------------------------------
  var earthquakes = L.geoJSON(eqData, {
    onEachFeature: onEachEarthq
  });
  // --------------------------------------------------------------------------------------------------
