...
d3.json("data_candidates_file.json", function(dataRows) {
  ...
  for (i = 0; i < dataRows.length; i++) {
    ...
    candAnswer = president.candAnswer
    candPct = president.pct

    var candidates_data = dataRows[0];
    ...
    console.log("President:", president)
      ...
      //                                                Alemi March 5 2020
      // -----------------------------------------------------------------------------
      var presidentStatusCode = 'SANDERS';

      console.log("candLat:",candLat)
      console.log("candLat:",candLong)
      ...
      newMarkerP.bindPopup(president.candAnswer + "<br> votes percentage: " + president.pct + "<br>" + president.state + "State");
